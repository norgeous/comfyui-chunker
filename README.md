...
| 0            | 1                   | 0                   | cv1 then blank         | all white                      | chunked t2v from starting pose                             | t2v with starting pose                                        |
...
| 1            | 1                   | 0                   | cv1 then blank         | all white                      | chunked i2v from starting pose                             | i2v with starting pose                                        |
...
| 0            | 0                   | 2                   | blank                  | chunk of masks                 | chunked t2v of animated non-rectangular shape              | t2v with animated shape?                                      |
| 0            | 2                   | 0                   | chunk of cv            | all white                      | chunked v2v from poses                                     | v2v pose reimagine                                            |
| 0            | 2                   | 2                   | chunk of cv            | chunk of masks                 | chunked v2v from poses and masks                           | v2v pose reimagine masked                                     |
| 2            | 0                   | 0                   | chunk of im            | all white                      | chunked v2v                                                | v2v denoise                                                   |
| 2            | 0                   | 2                   | chunk of im            | chunk of masks                 | chunked v2v from masks                                     | v2v inpainting, outpainting or denoise specific area in video |
| 2            | 2                   | 0                   | chunk of cv            | all white                      | chunked v2v from poses                                     | v2v pose reimagine                                            |
| 2            | 2                   | 2                   | chunk of cv            | chunk of masks                 | chunked v2v from poses and masks                           | v2v person inpainting                                         |
