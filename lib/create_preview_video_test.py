...
def test_create_preview_video_with_images_masks_audio(output_dir):
    ...
    d = {"index": 0, "fps": 15.0}
    c = {"chunk_length": 30, "chunk_overlap": 10, "chunk_count": 2, "total_length": 50}
    ...
    av_save(images=result, audio=audio, output_path=output_path, fps=15.0, profile=Profile.WEB)
